...
This conftest.py is discovered early by pytest during plugin loading,
...
def pytest_addoption(parser: 'Parser') -> None:
    ...
    This hook must be at the root level for pytest to discover it early
    during plugin loading (before argument parsing).
    """
    parser.addoption(
