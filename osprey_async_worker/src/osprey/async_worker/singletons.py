...
def _resolve_sources_provider() -> BaseSourcesProvider:
    ...
    """
    # Local imports avoid pulling gevent or etcd at module import time for
    # consumers that never call ENGINE.instance().
...
def _init_engine() -> 'AsyncOspreyEngine':
    ...
    """
    # Local imports to avoid import cycles and to defer heavy plugin loading
    # until the singleton is actually requested.
