...
- Add Rules Registry page at `/rules` (also served at `/api/rules`) — browse named `Rule(...)` definitions across the engine with conditions, descriptions, referenced features, and WhenRules reference counts ([#277](https://github.com/roostorg/osprey/pull/277) by [@haileyok](https://github.com/haileyok))
