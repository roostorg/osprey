...
- Add project-scoped Playwright MCP registration (`@playwright/mcp@0.0.73` via `pnpm dlx`) so Claude Code can drive a browser against `osprey_ui` for ad-hoc UI verification ([#243](https://github.com/roostorg/osprey/pull/243) by [@haileyok](https://github.com/haileyok))
