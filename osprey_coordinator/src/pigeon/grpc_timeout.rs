//! Copy of
//! https://github.com/hyperium/tonic/blob/v0.6.2/tonic/src/transport/service/grpc_timeout.rs
...
{
    type Output = Result<Res, super::utils::Error>;
    ...
    fn poll(self: Pin<&mut Self>, cx: &mut Context<'_>) -> Poll<Self::Output> {
        ...
        if let OptionPinProj::Some { inner: sleep } = this.sleep.project() {
...
/// Copy of [`tonic::transport::TimeoutExpired`].
#[derive(Debug)]
