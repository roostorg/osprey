...
@typing.final
class AesGcmKeyFormat(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["key_size", b"key_size", "version", b"version"]) -> None: ...

global___AesGcmKeyFormat = AesGcmKeyFormat

@typing.final
class AesGcmKey(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["key_value", b"key_value", "version", b"version"]) -> None: ...

global___AesGcmKey = AesGcmKey
