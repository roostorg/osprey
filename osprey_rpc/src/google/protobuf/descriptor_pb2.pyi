...
class FileDescriptorProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["name", b"name", "options", b"options", "package", b"package", "source_code_info", b"source_code_info", "syntax", b"syntax"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["dependency", b"dependency", "enum_type", b"enum_type", "extension", b"extension", "message_type", b"message_type", "name", b"name", "options", b"options", "package", b"package", "public_dependency", b"public_dependency", "service", b"service", "source_code_info", b"source_code_info", "syntax", b"syntax", "weak_dependency", b"weak_dependency"]) -> None: ...
...
class ExtensionRangeOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["uninterpreted_option", b"uninterpreted_option"]) -> None: ...
...
class MessageOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["deprecated", b"deprecated", "map_entry", b"map_entry", "message_set_wire_format", b"message_set_wire_format", "no_standard_descriptor_accessor", b"no_standard_descriptor_accessor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["deprecated", b"deprecated", "map_entry", b"map_entry", "message_set_wire_format", b"message_set_wire_format", "no_standard_descriptor_accessor", b"no_standard_descriptor_accessor", "uninterpreted_option", b"uninterpreted_option"]) -> None: ...
...
class FieldOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["ctype", b"ctype", "deprecated", b"deprecated", "jstype", b"jstype", "lazy", b"lazy", "packed", b"packed", "unverified_lazy", b"unverified_lazy", "weak", b"weak"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["ctype", b"ctype", "deprecated", b"deprecated", "jstype", b"jstype", "lazy", b"lazy", "packed", b"packed", "uninterpreted_option", b"uninterpreted_option", "unverified_lazy", b"unverified_lazy", "weak", b"weak"]) -> None: ...
...
class EnumOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["allow_alias", b"allow_alias", "deprecated", b"deprecated"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["allow_alias", b"allow_alias", "deprecated", b"deprecated", "uninterpreted_option", b"uninterpreted_option"]) -> None: ...
...
class EnumValueOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["deprecated", b"deprecated"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["deprecated", b"deprecated", "uninterpreted_option", b"uninterpreted_option"]) -> None: ...
...
class MethodOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["deprecated", b"deprecated", "idempotency_level", b"idempotency_level"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["deprecated", b"deprecated", "idempotency_level", b"idempotency_level", "uninterpreted_option", b"uninterpreted_option"]) -> None: ...
...
class GeneratedCodeInfo(google.protobuf.message.Message):
    ...
    class Annotation(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["begin", b"begin", "end", b"end", "source_file", b"source_file"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["begin", b"begin", "end", b"end", "path", b"path", "source_file", b"source_file"]) -> None: ...
