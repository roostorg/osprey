...
class MessageStoragePolicy(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["allowed_persistence_regions", b"allowed_persistence_regions"]) -> None: ...
...
class SchemaSettings(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["encoding", b"encoding", "schema", b"schema"]) -> None: ...
...
class Topic(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        message_storage_policy: global___MessageStoragePolicy | None = ...,
        kms_key_name: builtins.str = ...,
        schema_settings: global___SchemaSettings | None = ...,
        satisfies_pzs: builtins.bool = ...,
        message_retention_duration: google.protobuf.duration_pb2.Duration | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["message_retention_duration", b"message_retention_duration", "message_storage_policy", b"message_storage_policy", "schema_settings", b"schema_settings"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["kms_key_name", b"kms_key_name", "labels", b"labels", "message_retention_duration", b"message_retention_duration", "message_storage_policy", b"message_storage_policy", "name", b"name", "satisfies_pzs", b"satisfies_pzs", "schema_settings", b"schema_settings"]) -> None: ...
...
class PubsubMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["attributes", b"attributes", "data", b"data", "message_id", b"message_id", "ordering_key", b"ordering_key", "publish_time", b"publish_time"]) -> None: ...
...
class UpdateTopicRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["topic", b"topic", "update_mask", b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["topic", b"topic", "update_mask", b"update_mask"]) -> None: ...
...
class PublishRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        topic: builtins.str = ...,
        messages: collections.abc.Iterable[global___PubsubMessage] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["messages", b"messages", "topic", b"topic"]) -> None: ...
...
class ListTopicsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["page_size", b"page_size", "page_token", b"page_token", "project", b"project"]) -> None: ...
...
class ListTopicSubscriptionsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["page_size", b"page_size", "page_token", b"page_token", "topic", b"topic"]) -> None: ...
...
class ListTopicSubscriptionsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["next_page_token", b"next_page_token", "subscriptions", b"subscriptions"]) -> None: ...
...
class ListTopicSnapshotsResponse(google.protobuf.message.Message):
    ...
    """
    @property
    def snapshots(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
        """The names of the snapshots that match the request."""

    def __init__(
        self,
        *,
        snapshots: collections.abc.Iterable[builtins.str] | None = ...,
        next_page_token: builtins.str = ...,
    ) -> None: ...
...
class RetryPolicy(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        minimum_backoff: google.protobuf.duration_pb2.Duration | None = ...,
        maximum_backoff: google.protobuf.duration_pb2.Duration | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["maximum_backoff", b"maximum_backoff", "minimum_backoff", b"minimum_backoff"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["maximum_backoff", b"maximum_backoff", "minimum_backoff", b"minimum_backoff"]) -> None: ...
...
class DeadLetterPolicy(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dead_letter_topic", b"dead_letter_topic", "max_delivery_attempts", b"max_delivery_attempts"]) -> None: ...
...
class PushConfig(google.protobuf.message.Message):
    ...
    class OidcToken(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["audience", b"audience", "service_account_email", b"service_account_email"]) -> None: ...
    ...
    def __init__(
        ...
        *,
        push_endpoint: builtins.str = ...,
        attributes: collections.abc.Mapping[builtins.str, builtins.str] | None = ...,
        oidc_token: global___PushConfig.OidcToken | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["authentication_method", b"authentication_method", "oidc_token", b"oidc_token"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["attributes", b"attributes", "authentication_method", b"authentication_method", "oidc_token", b"oidc_token", "push_endpoint", b"push_endpoint"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["authentication_method", b"authentication_method"]) -> typing.Literal["oidc_token"] | None: ...
...
class ReceivedMessage(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ack_id: builtins.str = ...,
        message: global___PubsubMessage | None = ...,
        delivery_attempt: builtins.int = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["message", b"message"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["ack_id", b"ack_id", "delivery_attempt", b"delivery_attempt", "message", b"message"]) -> None: ...
...
class UpdateSubscriptionRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["subscription", b"subscription", "update_mask", b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["subscription", b"subscription", "update_mask", b"update_mask"]) -> None: ...
...
class ModifyPushConfigRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["push_config", b"push_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["push_config", b"push_config", "subscription", b"subscription"]) -> None: ...
...
class PullRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["max_messages", b"max_messages", "return_immediately", b"return_immediately", "subscription", b"subscription"]) -> None: ...
...
class PullResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        received_messages: collections.abc.Iterable[global___ReceivedMessage] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["received_messages", b"received_messages"]) -> None: ...
...
class ModifyAckDeadlineRequest(google.protobuf.message.Message):
    ...
    """
    @property
    def ack_ids(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
    ...
    def __init__(
        ...
        *,
        subscription: builtins.str = ...,
        ack_ids: collections.abc.Iterable[builtins.str] | None = ...,
        ack_deadline_seconds: builtins.int = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["ack_deadline_seconds", b"ack_deadline_seconds", "ack_ids", b"ack_ids", "subscription", b"subscription"]) -> None: ...
...
class AcknowledgeRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["ack_ids", b"ack_ids", "subscription", b"subscription"]) -> None: ...
...
class StreamingPullRequest(google.protobuf.message.Message):
    ...
    @property
    def modify_deadline_ack_ids(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
...
class StreamingPullResponse(google.protobuf.message.Message):
    ...
    class SubscriptionProperties(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["message_ordering_enabled", b"message_ordering_enabled"]) -> None: ...
    ...
    def __init__(
        ...
        *,
        received_messages: collections.abc.Iterable[global___ReceivedMessage] | None = ...,
        subscription_properties: global___StreamingPullResponse.SubscriptionProperties | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["subscription_properties", b"subscription_properties"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["received_messages", b"received_messages", "subscription_properties", b"subscription_properties"]) -> None: ...
...
class CreateSnapshotRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["labels", b"labels", "name", b"name", "subscription", b"subscription"]) -> None: ...
...
class UpdateSnapshotRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["snapshot", b"snapshot", "update_mask", b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["snapshot", b"snapshot", "update_mask", b"update_mask"]) -> None: ...
...
class Snapshot(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["expire_time", b"expire_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["expire_time", b"expire_time", "labels", b"labels", "name", b"name", "topic", b"topic"]) -> None: ...
...
class SeekRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["snapshot", b"snapshot", "target", b"target", "time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["snapshot", b"snapshot", "subscription", b"subscription", "target", b"target", "time", b"time"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["target", b"target"]) -> typing.Literal["time", "snapshot"] | None: ...
