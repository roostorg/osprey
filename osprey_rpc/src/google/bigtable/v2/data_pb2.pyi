...
class Row(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        key: builtins.bytes = ...,
        families: collections.abc.Iterable[global___Family] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["families", b"families", "key", b"key"]) -> None: ...
...
class Column(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["cells", b"cells", "qualifier", b"qualifier"]) -> None: ...
...
class Cell(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["labels", b"labels", "timestamp_micros", b"timestamp_micros", "value", b"value"]) -> None: ...
...
class RowRange(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["end_key", b"end_key", "end_key_closed", b"end_key_closed", "end_key_open", b"end_key_open", "start_key", b"start_key", "start_key_closed", b"start_key_closed", "start_key_open", b"start_key_open"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["end_key", b"end_key", "end_key_closed", b"end_key_closed", "end_key_open", b"end_key_open", "start_key", b"start_key", "start_key_closed", b"start_key_closed", "start_key_open", b"start_key_open"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["end_key", b"end_key"]) -> typing.Literal["end_key_open", "end_key_closed"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["start_key", b"start_key"]) -> typing.Literal["start_key_closed", "start_key_open"] | None: ...
...
class RowSet(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        row_keys: collections.abc.Iterable[builtins.bytes] | None = ...,
        row_ranges: collections.abc.Iterable[global___RowRange] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["row_keys", b"row_keys", "row_ranges", b"row_ranges"]) -> None: ...
...
class ColumnRange(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["end_qualifier", b"end_qualifier", "end_qualifier_closed", b"end_qualifier_closed", "end_qualifier_open", b"end_qualifier_open", "start_qualifier", b"start_qualifier", "start_qualifier_closed", b"start_qualifier_closed", "start_qualifier_open", b"start_qualifier_open"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["end_qualifier", b"end_qualifier", "end_qualifier_closed", b"end_qualifier_closed", "end_qualifier_open", b"end_qualifier_open", "family_name", b"family_name", "start_qualifier", b"start_qualifier", "start_qualifier_closed", b"start_qualifier_closed", "start_qualifier_open", b"start_qualifier_open"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["end_qualifier", b"end_qualifier"]) -> typing.Literal["end_qualifier_closed", "end_qualifier_open"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["start_qualifier", b"start_qualifier"]) -> typing.Literal["start_qualifier_closed", "start_qualifier_open"] | None: ...
...
class TimestampRange(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["end_timestamp_micros", b"end_timestamp_micros", "start_timestamp_micros", b"start_timestamp_micros"]) -> None: ...
...
class ValueRange(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["end_value", b"end_value", "end_value_closed", b"end_value_closed", "end_value_open", b"end_value_open", "start_value", b"start_value", "start_value_closed", b"start_value_closed", "start_value_open", b"start_value_open"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["end_value", b"end_value", "end_value_closed", b"end_value_closed", "end_value_open", b"end_value_open", "start_value", b"start_value", "start_value_closed", b"start_value_closed", "start_value_open", b"start_value_open"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["end_value", b"end_value"]) -> typing.Literal["end_value_closed", "end_value_open"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["start_value", b"start_value"]) -> typing.Literal["start_value_closed", "start_value_open"] | None: ...
    ...
    * Chains and interleaves are described in more detail in the
    ...
    class Chain(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            filters: collections.abc.Iterable[global___RowFilter] | None = ...,
        ) -> None: ...
    ...
    class Condition(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            predicate_filter: global___RowFilter | None = ...,
            true_filter: global___RowFilter | None = ...,
            false_filter: global___RowFilter | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["false_filter", b"false_filter", "predicate_filter", b"predicate_filter", "true_filter", b"true_filter"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["false_filter", b"false_filter", "predicate_filter", b"predicate_filter", "true_filter", b"true_filter"]) -> None: ...
    ...
    """
    family_name_regex_filter: builtins.str
    ...
    apply_label_transformer: builtins.str
    ...
    def __init__(
        self,
        *,
        chain: global___RowFilter.Chain | None = ...,
        interleave: global___RowFilter.Interleave | None = ...,
        condition: global___RowFilter.Condition | None = ...,
        sink: builtins.bool = ...,
        pass_all_filter: builtins.bool = ...,
        block_all_filter: builtins.bool = ...,
        row_key_regex_filter: builtins.bytes = ...,
        ...
        family_name_regex_filter: builtins.str = ...,
        column_qualifier_regex_filter: builtins.bytes = ...,
        column_range_filter: global___ColumnRange | None = ...,
        timestamp_range_filter: global___TimestampRange | None = ...,
        value_regex_filter: builtins.bytes = ...,
        value_range_filter: global___ValueRange | None = ...,
        cells_per_row_offset_filter: builtins.int = ...,
        cells_per_row_limit_filter: builtins.int = ...,
        cells_per_column_limit_filter: builtins.int = ...,
        strip_value_transformer: builtins.bool = ...,
...
class Mutation(google.protobuf.message.Message):
    ...
    class SetCell(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["column_qualifier", b"column_qualifier", "family_name", b"family_name", "timestamp_micros", b"timestamp_micros", "value", b"value"]) -> None: ...
    ...
    class DeleteFromColumn(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            family_name: builtins.str = ...,
            column_qualifier: builtins.bytes = ...,
            time_range: global___TimestampRange | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["time_range", b"time_range"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["column_qualifier", b"column_qualifier", "family_name", b"family_name", "time_range", b"time_range"]) -> None: ...
    ...
    def __init__(
        self,
        *,
        set_cell: global___Mutation.SetCell | None = ...,
        delete_from_column: global___Mutation.DeleteFromColumn | None = ...,
        delete_from_family: global___Mutation.DeleteFromFamily | None = ...,
        delete_from_row: global___Mutation.DeleteFromRow | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["delete_from_column", b"delete_from_column", "delete_from_family", b"delete_from_family", "delete_from_row", b"delete_from_row", "mutation", b"mutation", "set_cell", b"set_cell"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["delete_from_column", b"delete_from_column", "delete_from_family", b"delete_from_family", "delete_from_row", b"delete_from_row", "mutation", b"mutation", "set_cell", b"set_cell"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["mutation", b"mutation"]) -> typing.Literal["set_cell", "delete_from_column", "delete_from_family", "delete_from_row"] | None: ...
...
class ReadModifyWriteRule(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["append_value", b"append_value", "increment_amount", b"increment_amount", "rule", b"rule"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["append_value", b"append_value", "column_qualifier", b"column_qualifier", "family_name", b"family_name", "increment_amount", b"increment_amount", "rule", b"rule"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["rule", b"rule"]) -> typing.Literal["append_value", "increment_amount"] | None: ...
