...
class ReadRowsRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        table_name: builtins.str = ...,
        app_profile_id: builtins.str = ...,
        rows: google.bigtable.v2.data_pb2.RowSet | None = ...,
        filter: google.bigtable.v2.data_pb2.RowFilter | None = ...,
        rows_limit: builtins.int = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["filter", b"filter", "rows", b"rows"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["app_profile_id", b"app_profile_id", "filter", b"filter", "rows", b"rows", "rows_limit", b"rows_limit", "table_name", b"table_name"]) -> None: ...
...
class ReadRowsResponse(google.protobuf.message.Message):
    ...
    class CellChunk(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            row_key: builtins.bytes = ...,
            family_name: google.protobuf.wrappers_pb2.StringValue | None = ...,
            qualifier: google.protobuf.wrappers_pb2.BytesValue | None = ...,
            timestamp_micros: builtins.int = ...,
        ...
        def HasField(self, field_name: typing.Literal["commit_row", b"commit_row", "family_name", b"family_name", "qualifier", b"qualifier", "reset_row", b"reset_row", "row_status", b"row_status"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["commit_row", b"commit_row", "family_name", b"family_name", "labels", b"labels", "qualifier", b"qualifier", "reset_row", b"reset_row", "row_key", b"row_key", "row_status", b"row_status", "timestamp_micros", b"timestamp_micros", "value", b"value", "value_size", b"value_size"]) -> None: ...
        def WhichOneof(self, oneof_group: typing.Literal["row_status", b"row_status"]) -> typing.Literal["reset_row", "commit_row"] | None: ...
    ...
    def __init__(
        self,
        *,
        chunks: collections.abc.Iterable[global___ReadRowsResponse.CellChunk] | None = ...,
        last_scanned_row_key: builtins.bytes = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["chunks", b"chunks", "last_scanned_row_key", b"last_scanned_row_key"]) -> None: ...
...
class SampleRowKeysRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["app_profile_id", b"app_profile_id", "table_name", b"table_name"]) -> None: ...
...
class SampleRowKeysResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["offset_bytes", b"offset_bytes", "row_key", b"row_key"]) -> None: ...
...
class MutateRowRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        app_profile_id: builtins.str = ...,
        row_key: builtins.bytes = ...,
        mutations: collections.abc.Iterable[google.bigtable.v2.data_pb2.Mutation] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["app_profile_id", b"app_profile_id", "mutations", b"mutations", "row_key", b"row_key", "table_name", b"table_name"]) -> None: ...
...
class MutateRowsRequest(google.protobuf.message.Message):
    ...
    class Entry(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["mutations", b"mutations", "row_key", b"row_key"]) -> None: ...
    ...
    def __init__(
        ...
        *,
        table_name: builtins.str = ...,
        app_profile_id: builtins.str = ...,
        entries: collections.abc.Iterable[global___MutateRowsRequest.Entry] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["app_profile_id", b"app_profile_id", "entries", b"entries", "table_name", b"table_name"]) -> None: ...
...
class MutateRowsResponse(google.protobuf.message.Message):
    ...
    class Entry(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["index", b"index", "status", b"status"]) -> None: ...
    ...
    def __init__(
        self,
        *,
        entries: collections.abc.Iterable[global___MutateRowsResponse.Entry] | None = ...,
    ) -> None: ...
...
class CheckAndMutateRowRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        app_profile_id: builtins.str = ...,
        row_key: builtins.bytes = ...,
        predicate_filter: google.bigtable.v2.data_pb2.RowFilter | None = ...,
        true_mutations: collections.abc.Iterable[google.bigtable.v2.data_pb2.Mutation] | None = ...,
        false_mutations: collections.abc.Iterable[google.bigtable.v2.data_pb2.Mutation] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["predicate_filter", b"predicate_filter"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["app_profile_id", b"app_profile_id", "false_mutations", b"false_mutations", "predicate_filter", b"predicate_filter", "row_key", b"row_key", "table_name", b"table_name", "true_mutations", b"true_mutations"]) -> None: ...
...
class CheckAndMutateRowResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["predicate_matched", b"predicate_matched"]) -> None: ...
...
class ReadModifyWriteRowRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        app_profile_id: builtins.str = ...,
        row_key: builtins.bytes = ...,
        rules: collections.abc.Iterable[google.bigtable.v2.data_pb2.ReadModifyWriteRule] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["app_profile_id", b"app_profile_id", "row_key", b"row_key", "rules", b"rules", "table_name", b"table_name"]) -> None: ...
...
class ReadModifyWriteRowResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        row: google.bigtable.v2.data_pb2.Row | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["row", b"row"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["row", b"row"]) -> None: ...
