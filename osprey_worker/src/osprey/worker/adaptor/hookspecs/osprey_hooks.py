...
@hookspec
def register_input_sink(config: Config) -> BaseInputStream[Action]:
    """Returns input sink instances to use with the engine."""
    raise NotImplementedError('register_input_sink must be implemented by the plugin')
