...
class TestMeasureStub:
    def test_measure_returns_internal_error_for_now(self, capsys: pytest.CaptureFixture) -> None:
    ...
    def test_main_dispatches_to_measure(self, capsys: pytest.CaptureFixture) -> None:
        rc = main(['measure'])
        assert rc == EXIT_INTERNAL_ERROR
