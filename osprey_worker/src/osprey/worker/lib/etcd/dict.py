...
# Apparently we can't easily add pip requirements for transitive dependencies of confy...
...
class ReadOnlyEtcdDict(Mapping[K, V]):
    def __init__(self, etcd_key: str, etcd_client: Optional[etcd.EtcdClient] = None, lazy=True, serializer=json):
