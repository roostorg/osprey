...
from osprey.worker._stdlibplugin.event_query_backend_register import register_event_query_backend
...
__all__ = [
    'register_output_sinks',
    'register_udfs',
    'register_ast_validators',
    'register_execution_result_store',
    'register_event_query_backend',
]
