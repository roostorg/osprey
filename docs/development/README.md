...
The [User Guide](../user/README.md) covers the full investigation workflow, and [Writing Rules](../rules.md) explains the SML behind `ContainsHello` and how to write your own rules.
