...
If you want Osprey to track state across events (e.g., "this user has 3 prior violations"), implement `register_labels_service_or_provider`. `example_plugins/src/services/labels_service.py` is a full reference implementation backed by Postgres, and a good starting point if you're building your own.
